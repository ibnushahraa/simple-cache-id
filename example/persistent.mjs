...
// Save to disk
console.log("\n💾 Saving cache to disk (./.cache/example-esm-cache.sdb)...");
cache.destroy();

console.log("✅ Done! Run this script again to see data persistence.\n");
console.log("💡 Tip: The cache file is saved at ./.cache/example-esm-cache.sdb");
